...
<form class="form-signin" name="fo" method="post" action="">
  ...
  <input class="form-control" type="text" name="nom" placeholder="Nom" value="<?php echo $nom?>"  required autofocus /><br />
  <input class="form-control"  type="text" name="prenom" placeholder="Prénom" value="<?php echo $prenom?>"  required /><br />
  <input class="form-control" type="text" name="login" placeholder="Login" value="<?php echo $login?>" required /><br />
  <input class="form-control" type="password" name="pass" placeholder="Mot de passe" required /><br />
  <input class="form-control" type="password" name="repass" placeholder="Confirmer Mot de passe" required /><br />
